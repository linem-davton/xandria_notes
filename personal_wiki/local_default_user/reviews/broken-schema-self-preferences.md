---
schema_version: 1
title: "Broken Schema: Preferences"
page_status: active
aliases:
  - broken schema self/preferences
...
Update `self/preferences` so its frontmatter and typed blocks match the path-derived page family schema.
