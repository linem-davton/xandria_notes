---
schema_version: 1
title: "Broken Schema: Hobbies"
page_status: active
aliases:
  - broken schema life-areas/hobbies
...
Update `life-areas/hobbies` so its frontmatter and typed blocks match the path-derived page family schema.
