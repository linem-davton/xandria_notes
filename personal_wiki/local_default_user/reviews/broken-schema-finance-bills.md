---
schema_version: 1
title: "Broken Schema: Bills"
page_status: active
aliases:
  - broken schema finance/bills
...
Update `finance/bills` so its frontmatter and typed blocks match the path-derived page family schema.
