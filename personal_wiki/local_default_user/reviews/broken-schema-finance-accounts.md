---
schema_version: 1
title: "Broken Schema: Accounts"
page_status: active
aliases:
  - broken schema finance/accounts
...
Update `finance/accounts` so its frontmatter and typed blocks match the path-derived page family schema.
