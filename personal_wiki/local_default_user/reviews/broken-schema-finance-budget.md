---
schema_version: 1
title: "Broken Schema: Budget"
page_status: active
aliases:
  - broken schema finance/budget
...
Update `finance/budget` so its frontmatter and typed blocks match the path-derived page family schema.
