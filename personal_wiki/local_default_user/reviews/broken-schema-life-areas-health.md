---
schema_version: 1
title: "Broken Schema: Health"
page_status: active
aliases:
  - broken schema life-areas/health
...
Update `life-areas/health` so its frontmatter and typed blocks match the path-derived page family schema.
