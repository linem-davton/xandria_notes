---
schema_version: 1
title: "Broken Schema: Profile"
page_status: active
aliases:
  - broken schema self/profile
...
Update `self/profile` so its frontmatter and typed blocks match the path-derived page family schema.
