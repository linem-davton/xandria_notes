---
schema_version: 1
title: "Broken Schema: Boundaries"
page_status: active
aliases:
  - broken schema self/boundaries
...
Update `self/boundaries` so its frontmatter and typed blocks match the path-derived page family schema.
