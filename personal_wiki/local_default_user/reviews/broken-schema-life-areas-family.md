---
schema_version: 1
title: "Broken Schema: Family"
page_status: active
aliases:
  - broken schema life-areas/family
...
Update `life-areas/family` so its frontmatter and typed blocks match the path-derived page family schema.
