---
schema_version: 1
title: "Broken Schema: Study"
page_status: active
aliases:
  - broken schema life-areas/study
...
Update `life-areas/study` so its frontmatter and typed blocks match the path-derived page family schema.
