---
schema_version: 1
title: "Broken Schema: Work"
page_status: active
aliases:
  - broken schema life-areas/work
...
Update `life-areas/work` so its frontmatter and typed blocks match the path-derived page family schema.
